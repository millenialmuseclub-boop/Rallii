...
export interface CourseMedia { representative?: boolean; id: string; courseSlug?: string; destinationSlug?: string; collectionSlug?: string; src: string; alt: string; caption?: string; creator: string; license: string; licenseUrl: string; sourceUrl: string; accessedAt: string; role: MediaRole; width: number; height: number; fileSize: number; focalPoint?: string; reuseNotes: string; attribution: string; status: "published" | "review" }
