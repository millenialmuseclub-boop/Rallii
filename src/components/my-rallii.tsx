...
export function MyRallii({ experiences }: { experiences: SavedExperience[] }) {
  ...
  return <div className="family-workspace">
    ...
    <section className="family-collections" aria-labelledby="collections-title"><p className="eyebrow">Rallii Pro</p><h2 id="collections-title">Trips that bring it all together</h2><p>Collect rail journeys, golf courses, hiking trails, MTB rides and snow destinations in one place, with your own trip notes.</p>
