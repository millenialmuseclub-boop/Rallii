...
export function FamilyHeader({ trail = false }: { trail?: boolean }) {
  return <header className="rallii-header"><div className="rallii-container rallii-header-inner">
    <Link className="rallii-wordmark" href="/" aria-label="Rallii home"><RalliiMark />Rallii{trail ? <span> / Trail</span> : null}</Link>
