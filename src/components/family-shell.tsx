...
export function FamilyShell({ children }: { children: React.ReactNode }) {
  ...
  return <div data-experience={activity === "trail" || activity === "mtb" || activity === "snow" ? "rail" : activity}><MobileShell />{children}{activity !== "green" ? <SiteFooter compact={path === "/"} /> : null}</div>;
}
