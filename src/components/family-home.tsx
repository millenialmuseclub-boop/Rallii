...
export function FamilyHome() {
  return <><FamilyHeader /><main className="rallii-editorial">
    ...
    <FamilySavedPreview />
    <section className="rallii-container rallii-family-pro"><div><p className="rallii-kicker">Rallii Pro / Across the family</p><h2>More to your journey.<br /><em>One membership.</em></h2><p>Bring Rail, Green, Trail and MTB into the same trip, with private collections and notes. One Rallii Pro entitlement, wherever curiosity takes you.</p><Link className="rallii-button rallii-button-light" href="/pro/">Explore Rallii Pro ↗</Link></div><div><p className="rallii-pro-label">Plan with more possibility</p><ul><li>Shared trip collections & private notes</li><li>Unlimited Rail saves & supported Scenic Alerts</li><li>Trail & MTB maps, offline guides & location tools <small>Planned</small></li></ul><p className="rallii-pro-note">Purchases are not yet available. Trail and MTB discovery and saves are free.</p></div></section>
