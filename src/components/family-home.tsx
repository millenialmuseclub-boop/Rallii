...
export function FamilyHome() {
  return <><FamilyHeader /><main className="rallii-editorial">
    ...
    <section id="explore" className="rallii-container rallii-section"><div className="rallii-section-heading"><div><p className="rallii-kicker">Explore Rallii</p><h2>One curiosity.<br /><em>More ways to follow it.</em></h2></div><p>For the journey, the round, the walk.<br />And everything you find along the way.</p></div>
    ...
    <section className="rallii-featured-band"><div className="rallii-container rallii-section"><div className="rallii-section-heading"><div><p className="rallii-kicker">Featured right now / Editor’s picks</p><h2>Places that stay with you.</h2></div><p>Three very good reasons to go.</p></div><div className="rallii-featured-list">
    ...
    <FamilySavedPreview />
    <section className="rallii-container rallii-family-pro"><div><p className="rallii-kicker">Rallii Pro / Across the family</p><h2>More to your journey.<br /><em>One membership.</em></h2><p>Bring Rail, Green and Trail into the same trip, with private collections and notes. One Rallii Pro entitlement, wherever curiosity takes you.</p><Link className="rallii-button rallii-button-light" href="/pro/">Explore Rallii Pro ↗</Link></div><div><p className="rallii-pro-label">Plan with more possibility</p><ul><li>Shared trip collections & private notes</li><li>Unlimited Rail saves & supported Scenic Alerts</li><li>Trail maps, offline guides & location tools <small>Planned</small></li></ul><p className="rallii-pro-note">Purchases are not yet available. Trail discovery and saves are free.</p></div></section>
