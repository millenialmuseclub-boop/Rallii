...
export const journeyCollections: JourneyCollection[] = [
  ...
  { slug: "northern-landscapes", title: "Northern Landscapes", description: "Remote Highland, fjord, and north-coast journeys with a strong sense of place.", routeSlugs: ["west-highland-line", "flam-railway", "bergen-line", "belfast-derry", "settle-carlisle"] },
  ...
  { slug: "mountain-journeys", title: "Mountain Journeys", description: "Railways shaped by high passes, steep valleys, and memorable mountain engineering.", routeSlugs: ["tranzalpine", "glacier-express", "bernina-express", "flam-railway", "bergen-line", "kurobe-gorge-railway", "first-passage-west", "settle-carlisle", "california-zephyr", "kandy-ella-railway", "coast-starlight", "the-canadian", "eastern-express", "hiram-bingham", "alishan-forest-railway"] },
  ...
  { slug: "multi-day-journeys", title: "Multi-Day Journeys", description: "Long-form railway experiences that continue across one or more nights.", routeSlugs: ["the-ghan", "first-passage-west", "california-zephyr", "coast-starlight", "the-canadian", "eastern-express"] },
  { slug: "great-rail-crossings", title: "Great Rail Crossings", description: "Long-distance journeys whose changing landscapes reveal the scale of a country or continent.", routeSlugs: ["tranzalpine", "bergen-line", "the-ghan", "first-passage-west", "california-zephyr", "coast-starlight", "the-canadian"] },
];
