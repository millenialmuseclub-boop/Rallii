...
export const journeyCollections: JourneyCollection[] = [
  ...
  { slug: "northern-landscapes", title: "Northern Landscapes", description: "Remote Highland, fjord, and north-coast journeys with a strong sense of place.", routeSlugs: ["west-highland-line", "flam-railway", "bergen-line", "belfast-derry", "settle-carlisle", "inlandsbanan"], coverRouteSlug: "inlandsbanan" },
  ...
  { slug: "short-scenic-escapes", title: "Short Scenic Escapes", description: "Concentrated railway experiences that fit into a wider trip.", routeSlugs: ["flam-railway", "cinque-terre", "kurobe-gorge-railway", "train-des-merveilles"], coverRouteSlug: "train-des-merveilles" },
  { slug: "coastal-journeys", title: "Coastal Journeys", description: "Railways where sea, shoreline, and dramatic terrain shape the journey.", routeSlugs: ["cinque-terre", "west-highland-line", "belfast-derry", "dublin-rosslare", "coast-starlight"] },
  ...
  { slug: "mountain-journeys", title: "Mountain Journeys", description: "Railways shaped by high passes, steep valleys, and memorable mountain engineering.", routeSlugs: ["tranzalpine", "glacier-express", "bernina-express", "flam-railway", "bergen-line", "kurobe-gorge-railway", "first-passage-west", "settle-carlisle", "california-zephyr", "kandy-ella-railway", "coast-starlight", "the-canadian", "eastern-express", "hiram-bingham", "alishan-forest-railway", "belgrade-bar", "konkan-railway", "el-chepe-express", "train-des-merveilles"], coverRouteSlug: "bernina-express" },
  ...
  { slug: "railway-engineering", title: "Railway Engineering", description: "Journeys defined by viaducts, tunnels, mountain crossings, and the bold decisions that made the railway possible.", routeSlugs: ["glacier-express", "bernina-express", "flam-railway", "kurobe-gorge-railway", "settle-carlisle", "alishan-forest-railway", "belgrade-bar", "konkan-railway", "el-chepe-express"], coverRouteSlug: "bernina-express" },
  { slug: "gorge-and-valley-journeys", title: "Gorge & Valley Journeys", description: "Railways that follow rivers, sheer-sided gorges, and deep valleys where the view changes with every curve.", routeSlugs: ["glacier-express", "tranzalpine", "flam-railway", "kurobe-gorge-railway", "douro-line", "belgrade-bar", "el-chepe-express", "train-des-merveilles"], coverRouteSlug: "kurobe-gorge-railway" },
  { slug: "heritage-lines", title: "Heritage Lines", description: "Characterful railways where historic rolling stock, distinctive engineering, and a strong sense of railway history shape the experience.", routeSlugs: ["goldenpass-express", "flam-railway", "kurobe-gorge-railway", "alishan-forest-railway", "inlandsbanan", "train-des-merveilles"], coverRouteSlug: "alishan-forest-railway" },
