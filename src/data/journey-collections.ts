...
export const journeyCollections: JourneyCollection[] = [
  ...
  { slug: "short-scenic-escapes", title: "Short Scenic Escapes", description: "Concentrated railway experiences that fit into a wider trip.", routeSlugs: ["flam-railway", "cinque-terre", "kurobe-gorge-railway", "sagano-scenic-railway", "train-des-merveilles", "kuranda-scenic-railway"], coverRouteSlug: "train-des-merveilles" },
  { slug: "coastal-journeys", title: "Coastal Journeys", description: "Railways where sea, shoreline, and dramatic terrain shape the journey.", routeSlugs: ["cinque-terre", "west-highland-line", "jacobite-steam-train", "belfast-derry", "dublin-rosslare", "coast-starlight", "reunification-express"] },
