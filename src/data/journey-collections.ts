...
export const journeyCollections: JourneyCollection[] = [
  ...
  { slug: "full-day-journeys", title: "Full-Day Journeys", description: "Immersive routes where the railway journey becomes the day itself.", routeSlugs: ["glacier-express", "tranzalpine", "first-passage-west", "california-zephyr"] },
  { slug: "mountain-journeys", title: "Mountain Journeys", description: "Railways shaped by high passes, steep valleys, and memorable mountain engineering.", routeSlugs: ["tranzalpine", "glacier-express", "bernina-express", "flam-railway", "kurobe-gorge-railway", "first-passage-west", "settle-carlisle", "california-zephyr"] },
  ...
  { slug: "great-rail-crossings", title: "Great Rail Crossings", description: "Long-distance journeys whose changing landscapes reveal the scale of a country or continent.", routeSlugs: ["tranzalpine", "first-passage-west", "california-zephyr"] },
];
