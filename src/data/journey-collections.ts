...
export const journeyCollections: JourneyCollection[] = [
  ...
  { slug: "mountain-journeys", title: "Mountain Journeys", description: "Railways shaped by high passes, steep valleys, and memorable mountain engineering.", routeSlugs: ["tranzalpine", "glacier-express", "bernina-express", "flam-railway", "bergen-line", "kurobe-gorge-railway", "first-passage-west", "settle-carlisle", "california-zephyr", "kandy-ella-railway", "coast-starlight", "the-canadian"] },
  ...
  { slug: "multi-day-journeys", title: "Multi-Day Journeys", description: "Long-form railway experiences that continue across one or more nights.", routeSlugs: ["the-ghan", "first-passage-west", "california-zephyr", "coast-starlight", "the-canadian"] },
