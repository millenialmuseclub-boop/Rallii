...
export const berninaExpressRoute = {
  capabilities: { rideMode: true, scenicAlerts: true },
  summary: {
    id: "bernina-express",
  ...
  timelineEntries: [
    ...
    { id: "timeline-val-poschiavo", title: "Descending through Val Poschiavo", reverseTitle: "Climbing through Val Poschiavo", distanceAlongRouteKm: 40.7, approximateJourneyMinutes: 95, type: "scenic-section", importance: "highlight", bestSide: "varies", relatedLandmarkId: "val-poschiavo", shortDescription: "Repeated curves reveal the valley from changing sides of the train." },
    { id: "timeline-brusio", title: "Brusio Circular Viaduct", distanceAlongRouteKm: 54.7, approximateJourneyMinutes: 122, type: "viaduct", importance: "dont-miss", bestSide: "varies", relatedLandmarkId: "brusio-viaduct", shortDescription: "Watch the train curl around the stone spiral shortly before the Italian border.", reverseShortDescription: "Watch the train curl around the stone spiral soon after leaving the Italian border behind." },
  ],
  bestSideSegments: [
