...
export const flamRailwayRoute = {
  ...
  timelineEntries: [
    { id: "timeline-lower-valley", title: "Lower Flåmsdalen", subtitle: "Leaving the fjord", reverseSubtitle: "Returning to the fjord", distanceAlongRouteKm: 3.5, type: "scenic-section", importance: "highlight", bestSide: "varies", relatedLandmarkId: "lower-flamsdalen", shortDescription: "The railway quickly exchanges Flåm’s fjord-level setting for farms, river, and steep valley walls.", reverseShortDescription: "Farms and river accompany the final descent as the fjord-level setting opens around Flåm." },
    ...
    { id: "timeline-upper-ascent", title: "Upper mountain ascent", reverseTitle: "Upper mountain descent", subtitle: "Vatnahalsen & Myrdalsberget", distanceAlongRouteKm: 17.5, type: "scenic-section", importance: "dont-miss", bestSide: "varies", relatedLandmarkId: "myrdalsberget-ascent", shortDescription: "The final kilometres compress tunnels, sharp curves, and mountain terrain before Myrdal.", reverseShortDescription: "The opening kilometres compress mountain terrain, sharp curves, and tunnels below Myrdal." },
  ],
  bestSideSegments: [
