...
export const goldenPassExpressRoute = {
  ...
  timelineEntries: [
    { id: "timeline-lake-geneva", title: "Climbing from Montreux", reverseTitle: "Descending toward Montreux", subtitle: "Lake Geneva slopes", distanceAlongRouteKm: 4, approximateJourneyMinutes: 12, type: "scenic-section", importance: "highlight", bestSide: "varies", relatedLandmarkId: "lake-geneva-slopes", shortDescription: "Look back as the line rises from the Riviera into wooded slopes.", reverseShortDescription: "Watch for Lake Geneva as the line descends through wooded slopes toward the Riviera." },
    ...
    { id: "timeline-lake-thun", title: "Along Lake Thun", distanceAlongRouteKm: 105, approximateJourneyMinutes: 174, type: "lake", importance: "dont-miss", bestSide: "left", relatedLandmarkId: "lake-thun", shortDescription: "The final approach pairs the lake with the mountains of the Bernese Oberland.", reverseShortDescription: "The opening section pairs the lake with the mountains of the Bernese Oberland." },
  ],
  bestSideSegments: [
